...
function(
  ...
  return declare([BaseWidget], {
    ...
    baseClass: 'jimu-widget-SearchEFbyCity',    
  ...
  _drawEFxml: function () {
          ...
          var searchtext = string.trim(this.efsearchNode.value);
          var testpattern = /^[A-Za-z| ]+, {0,}[A-Za-z]{2}$/i;
          if (!(testpattern.test(searchtext))) {
            alert("You need to input City name and State Abbreviation separated by comma. Example: 'Chicago, VA'.");
            return false;
          }
          this._showloading();
          this.countdiv.innerHTML = "";
         ...
         var cityname = string.trim(searchtext.split(",")[0]);
         var stateabbr = string.trim(searchtext.split(",")[1]);
         cityname = cityname.replace(" ","%20");
         var inputurl = efsearchurl + "state_code/" + stateabbr.toUpperCase() + "/city_name/" + cityname.toUpperCase() + "/";
